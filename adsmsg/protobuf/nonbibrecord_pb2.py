...
_LINKRECORD = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='DOI', full_name='adsmsg.LinkRecord.DOI', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='ARXIV', full_name='adsmsg.LinkRecord.ARXIV', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='PRESENTATION', full_name='adsmsg.LinkRecord.PRESENTATION', index=5,
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='INSPIRE', full_name='adsmsg.LinkRecord.INSPIRE', index=7,
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='OPENURL', full_name='adsmsg.LinkRecord.OPENURL', index=9,
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='CITATIONS', full_name='adsmsg.LinkRecord.CITATIONS', index=12,
...
_DATASOURCE = _descriptor.Descriptor(
  name='DataSource',
  full_name='adsmsg.DataSource',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='id', full_name='adsmsg.DataSource.id', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='name', full_name='adsmsg.DataSource.name', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='url', full_name='adsmsg.DataSource.url', index=2,
...
_DATASOURCELIST = _descriptor.Descriptor(
  name='DataSourceList',
  full_name='adsmsg.DataSourceList',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='data_source', full_name='adsmsg.DataSourceList.data_source', index=0,
      number=1, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='status', full_name='adsmsg.DataSourceList.status', index=1,
      number=2, type=14, cpp_type=8, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_DATASOURCELIST.fields_by_name['data_source'].message_type = _DATASOURCE
_DATASOURCELIST.fields_by_name['status'].enum_type = status__pb2._STATUS
...
DataSource = _reflection.GeneratedProtocolMessageType('DataSource', (_message.Message,), dict(
  ...
  __module__ = 'nonbibrecord_pb2'
  # @@protoc_insertion_point(class_scope:adsmsg.DataSource)
  ))
_sym_db.RegisterMessage(DataSource)

DataSourceList = _reflection.GeneratedProtocolMessageType('DataSourceList', (_message.Message,), dict(
  DESCRIPTOR = _DATASOURCELIST,
  __module__ = 'nonbibrecord_pb2'
  # @@protoc_insertion_point(class_scope:adsmsg.DataSourceList)
  ))
